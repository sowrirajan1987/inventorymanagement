      ...
      cellRenderer: (params: { data: OutwardItem }) => {
        ...
        return (
          <div className="flex items-center gap-1">
            {userType === "Admin" && row.type === "itemissued" && row.quantity > 0 && (
              <Button
                variant="outline"
                size="sm"
                className="h-7 w-7 p-0 text-warning hover:bg-warning hover:text-warning-foreground"
                onClick={() => {
            ...
            {["itemrequested", "itemapproved", "itemissued", "itemrejected", "itemcancelled", "itemreturned"].includes(row.type) && (
              <Button
                variant="outline"
                size="sm"
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Outward Requests</h1>
          <p className="text-sm text-muted-foreground">Manage item requests and returns</p>
        </div>
      ...
      {/* Show Dashboard or Outward Table */}
      {showDashboard ? (
        <DashboardTable />
      ) : (
        <>
                  ...
                  <div className="flex-1">
                    <div className="flex items-start justify-between">
                      ...
                      <div className="flex gap-1">
                        {userType === "Admin" && item.type === "itemissued" && item.quantity > 0 && (
                          <Button
                            variant="outline"
                            size="sm"
                            className="h-7 w-7 p-0"
